                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <a href="javascript:void(0)">
                            <i class="material-icons">list</i> Danh sách người dùng
                        </a>
                    </li>
                </ol>
            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {{ Form::text('name',isset($filters['name']) ? $filters['name'] : '',array('placeholder'=>'Tên', 'class' => 'form-control', 'required')) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="table-responsive">
                                <table id="mainTable" class="table table-striped jambo_table responsive-utilities"
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            <td>
                                                {{ Form::checkbox('id[]', $user->id, false, array('class'=>'filled-in', 'id'=>'check_one'))}}
